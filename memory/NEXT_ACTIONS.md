...
已完成迭代：`ITER-00`至`ITER-15`。服务、售卡、次卡实耗、换卡补差、退卡及账单冲销提成联动已经完成；完整规则引擎、卡转赠谱系及真实电子退款仍是明确的未完成项。

## 持续开发顺序

1. 建立卡转赠谱系，保证转赠后退卡仍可追溯原售卡提成；再实现多人技师/售卡分配。
2. 开发累计阶梯、门店等级、岗位组合、店长提成和跨月负向调整规则及薪资测算。
