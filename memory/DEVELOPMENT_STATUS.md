...
| 数据库版本 | DONE | 0900、0910、1030、1100、1110、1120、1130、1140、1150、1160、1170共11个Migration脚本及人工记录 |
| 前端按需加载 | DONE | Element Plus按需加载，最大公共JS约166.79 KB |

## 最近验证

```text
./mvnw test
  37 tests，0 failure，0 error

pnpm test
  1个测试文件、2个测试通过

pnpm build
  含类型检查并通过；最大公共JS约166.79 KB（原约1.06 MB）
...
- SQL Server镜像未就绪，11个Migration及数据库版Mapper尚未在真实空库执行。
...
- 预约转账单、充值、积分、次卡售卡、资产组合结算和手工优惠已完成；优惠券、退款冲销及结算后回访/提成尚未接入。
