...
| 数据库版本 | DONE | 0900、0910、1030、1100、1110、1120、1130、1140、1150共9个Migration脚本及人工记录 |
...
```text
./mvnw test
  29 tests，0 failure，0 error

pnpm test
  1个测试文件、2个测试通过

pnpm build
  含类型检查并通过；最大公共JS约166.62 KB（原约1.06 MB）
...
- SQL Server镜像未就绪，9个Migration及数据库版Mapper尚未在真实空库执行。
...
- 预约转账单、充值、积分和次卡售卡已完成；资产结算抵扣、优惠券及结算后回访/提成尚未接入。
