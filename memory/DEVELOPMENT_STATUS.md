...
| 退卡/换卡提成冲回 | BLOCKED | 服务账单冲销已接通；售卡、退卡及换卡业务触发器尚未接入 |
...
- 提成当前只自动处理单技师服务账单和整单冲销；售卡、次卡实耗、换卡、退卡、多人分配、六种完整模式、阶梯和跨月口径尚未完成。
- 退卡电子退款目前只保存本地成功事实，不能作为真实通道退款验收；售卡技师和店长提成冲回仍为`PENDING_MODULE`。
