...
| 数据库版本 | DONE | 0900、0910、1030、1100、1110、1120、1130、1140、1150、1160、1170、1180共12个Migration脚本及人工记录 |
...
- SQL Server镜像未就绪，12个Migration及数据库版Mapper尚未在真实空库执行。
...
- 预约转账单、充值、积分、次卡售卡、资产组合结算、手工优惠和整单冲销已完成；部分退款、换卡/转赠/退卡、优惠券及结算后回访/提成尚未接入。
