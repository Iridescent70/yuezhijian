...
| `V202607291490` | 通知公告、门店范围、阅读记录、站内模板、权限和菜单 | `ntf_message`、`ntf_message_store`、`ntf_message_read`、`ntf_template`、`iam_*` |
| `V202607291500` | 礼品主档、门店库存、不可变流水、调拨、盘点、权限和菜单 | `cat_gift`、`inv_stock*`、`inv_transfer*`、`inv_count*`、`iam_*` |
...
| 版本 | 说明 | 状态 |
| --- | --- | --- |
| `V202607300100` | [初始化悦指间 P1 平台模型](./V202607300100__init_yuezhijian_p1_platform.md) | 本地独立 P1 库已执行 |
| `V202607300110` | [添加悦指间 P1 菜单](./V202607300110__add_yuezhijian_p1_menus.md) | 本地独立 P1 库已执行 |
| `V202607300120` | [确保悦指间会员权限](./V202607300120__ensure_yuezhijian_member_permissions.md) | 本地独立 P1 库已执行 |
